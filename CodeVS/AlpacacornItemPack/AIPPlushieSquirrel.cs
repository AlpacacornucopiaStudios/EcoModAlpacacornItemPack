namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieSquirrelObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieSquirrelItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Squirrel");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieSquirrelItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieSquirrelObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieSquirrelObject>(occupancies);
        }
    ...
    public partial class AIPPlushieSquirrelItem : WorldObjectItem<AIPPlushieSquirrelObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieSquirrelObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Squirrel Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieSquirrelRecipe : RecipeFamily
    {
        public AIPPlushieSquirrelRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieSquirrel", //noloc
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieSquirrelItem>(), });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Squirrel"), recipeType: typeof(AIPPlushieSquirrelRecipe));
            this.ModsPostInitialize();
