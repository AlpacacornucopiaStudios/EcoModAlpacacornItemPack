namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieBearPandaBowtiePinkObject : WorldObject, IRepresentsItem
    {
        ...
        {
            WorldObject.AddOccupancy<AIPPlushieBearPandaBowtiePinkObject>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    [LocDescription("A huggable Plushie Panda Bear stuffed with cotton wearing a Pink Bowtie. The Panda Bear appears to be wiggling and wants to be held.")]
    ...
    public partial class AIPPlushieBearPandaBowtiePinkRecipe : Recipe
    {
        public AIPPlushieBearPandaBowtiePinkRecipe()
        {
            ...
            {
                new CraftingElement<AIPPlushieBearPandaBowtiePinkItem>(),
            });

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Panda Bear with Pink Bowtie"
            this.ModsPostInitialize();
