namespace Eco.Mods.TechTree
{
    ...
    public partial class PlushieElephantObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(PlushieElephantItem);
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = PlushieElephantItem.homeValue;
            this.ModsPostInitialize();
        }

        static PlushieElephantObject()
        {
            WorldObject.AddOccupancy<PlushieElephantObject>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    public partial class PlushieElephantItem : WorldObjectItem<PlushieElephantObject>
    {
        ...
        {
            ObjectName = typeof(PlushieElephantObject).UILink(),
    ...
    {
        public PlushieElephantRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PlushieElephant", //noloc
            ...
            {
                new CraftingElement<PlushieElephantItem>(),
            });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Elephant"), recipeType: typeof(PlushieElephantRecipe));
            this.ModsPostInitialize();
