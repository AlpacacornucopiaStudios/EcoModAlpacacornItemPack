namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Hedgehog Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieHedgehogObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieHedgehogItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Hedgehog");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieHedgehogItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieHedgehogObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieHedgehogObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Hedgehog")]
    [LocDescription("A huggable Plushie Hedgehog stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieHedgehogItem : WorldObjectItem<AIPPlushieHedgehogObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieHedgehogObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Hedgehog Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieHedgehogRecipe : RecipeFamily
    {
        public AIPPlushieHedgehogRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieHedgehog", //noloc
            displayName: Localizer.DoStr("Plushie Hedgehog"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieHedgehogItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Hedgehog"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Hedgehog"), recipeType: typeof(AIPPlushieHedgehogRecipe));
            this.ModsPostInitialize();
