namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Mushroom 1 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieMushroom1Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieMushroom1Item);
        public override LocString DisplayName => Localizer.DoStr("Plushie Mushroom 1");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieMushroom1Item.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieMushroom1Object()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieMushroom1Object>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Mushroom 1")]
    ...
    public partial class AIPPlushieMushroom1Item : WorldObjectItem<AIPPlushieMushroom1Object>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieMushroom1Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Mushroom 1 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieMushroom1Recipe : RecipeFamily
    {
        public AIPPlushieMushroom1Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieMushroom1", //noloc
            displayName: Localizer.DoStr("Plushie Mushroom 1"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieMushroom1Item>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Mushroom 1"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Mushroom 1"), recipeType: typeof(AIPPlushieMushroom1Recipe));
            this.ModsPostInitialize();
