namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieCowObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieCowItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Cow");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieCowItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieCowObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieCowObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Cow")]
    [LocDescription("A huggable Plushie Cow stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieCowItem : WorldObjectItem<AIPPlushieCowObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieCowObject).UILink(),
    ...
    {
        public AIPPlushieCowRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieCow", //noloc
            displayName: Localizer.DoStr("Plushie Cow"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieCowItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Cow"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Cow"), recipeType: typeof(AIPPlushieCowRecipe));
            this.ModsPostInitialize();
