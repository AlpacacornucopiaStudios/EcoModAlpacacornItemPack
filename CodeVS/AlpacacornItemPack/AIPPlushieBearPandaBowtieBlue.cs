...
WorldObject.AddOccupancy<AIPPlushieBearPandaBowtieBlueObject>(occupancies);
}
...
[LocDescription("A huggable Plushie Panda Bear stuffed with cotton wearing a Blue Bowtie. The bear appears to be wiggling and wants to be held.")]
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushieBearPandaBowtieBlueItem>(),});
this.ModsPreInitialize();
this.ModsPostInitialize();
