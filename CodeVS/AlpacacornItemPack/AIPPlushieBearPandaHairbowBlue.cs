namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieBearPandaHairbowBlueObject : WorldObject, IRepresentsItem
    {
        ...
        static AIPPlushieBearPandaHairbowBlueObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieBearPandaHairbowBlueObject>(occupancies);
        }
    ...
    [LocDescription("A huggable Plushie Panda Bear stuffed with cotton wearing a Blue Hairbow. The bear appears to be wiggling and wants to be held.")]
    ...
    public partial class AIPPlushieBearPandaHairbowBlueRecipe : Recipe
    {
        public AIPPlushieBearPandaHairbowBlueRecipe()
        {
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieBearPandaHairbowBlueItem>(), });
            this.ModsPreInitialize();
            this.ModsPostInitialize();
