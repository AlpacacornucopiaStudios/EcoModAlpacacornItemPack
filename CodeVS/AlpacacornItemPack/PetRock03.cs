namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 03 Item")]
    [SupportedOSPlatform("windows7.0")]

    public partial class PetRock03Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(PetRock03Item);
        public override LocString DisplayName => Localizer.DoStr("Pet Rock 03");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = PetRock03Item.homeValue;
            this.ModsPostInitialize();
        }

        static PetRock03Object()
        {
            WorldObject.AddOccupancy<PetRock03Object>(new List<BlockOccupancy>(){
    ...
    public partial class PetRock03Item : WorldObjectItem<PetRock03Object>
    {
        ...
        {
            ObjectName = typeof(PetRock03Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 03 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class PetRock03Recipe : RecipeFamily
    {
        public PetRock03Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PetRock03", //noloc
                displayName: Localizer.DoStr("Pet Rock 03"),
            ...
            {
                new CraftingElement<PetRock03Item>(),
            });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pet Rock 03"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pet Rock 03"), recipeType: typeof(PetRock03Recipe));
            this.ModsPostInitialize();
