namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieBearPandaObject : WorldObject, IRepresentsItem
    {
        ...
        {
            WorldObject.AddOccupancy<AIPPlushieBearPandaObject>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Panda Bear Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieBearPandaRecipe : RecipeFamily
    {
        public AIPPlushieBearPandaRecipe()
        {
            ...
            {
                new CraftingElement<AIPPlushieBearPandaItem>(),
            });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Panda Bear"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Panda Bear"), recipeType: typeof(AIPPlushieBearPandaRecipe));
            this.ModsPostInitialize();
