namespace Eco.Mods.TechTree
{
    ...
    public partial class PetRock04Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(PetRock04Item);
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = PetRock04Item.homeValue;
            this.ModsPostInitialize();
        }

        static PetRock04Object()
        {
            WorldObject.AddOccupancy<PetRock04Object>(new List<BlockOccupancy>(){
    ...
    public partial class PetRock04Item : WorldObjectItem<PetRock04Object>
    {
        ...
        {
            ObjectName = typeof(PetRock04Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 04 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class PetRock04Recipe : RecipeFamily
    {
        public PetRock04Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PetRock04", //noloc
            ...
            {
                new CraftingElement<PetRock04Item>(),
            });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pet Rock 04"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pet Rock 04"), recipeType: typeof(PetRock04Recipe));
            this.ModsPostInitialize();
