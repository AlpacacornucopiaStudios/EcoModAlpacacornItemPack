namespace Eco.Mods.TechTree
{
    ...
    public partial class PetRock01Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(PetRock01Item);
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = PetRock01Item.homeValue;
            this.ModsPostInitialize();
        }

        static PetRock01Object()
        {
            WorldObject.AddOccupancy<PetRock01Object>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    public partial class PetRock01Item : WorldObjectItem<PetRock01Object>
    {
        ...
        {
            ObjectName = typeof(PetRock01Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 01 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class PetRock01Recipe : RecipeFamily
    {
        public PetRock01Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PetRock01", //noloc
            ...
            {
                new CraftingElement<PetRock01Item>(),
            });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pet Rock 01"), recipeType: typeof(PetRock01Recipe));
            this.ModsPostInitialize();
