namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Hippo Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieHippoObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieHippoItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Hippo");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieHippoItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieHippoObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieHippoObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Hippo")]
    [LocDescription("A huggable Plushie Hippo stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieHippoItem : WorldObjectItem<AIPPlushieHippoObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieHippoObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Hippo Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieHippoRecipe : RecipeFamily
    {
        public AIPPlushieHippoRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieHippo", //noloc
            displayName: Localizer.DoStr("Plushie Hippo"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieHippoItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Hippo"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Hippo"), recipeType: typeof(AIPPlushieHippoRecipe));
            this.ModsPostInitialize();
