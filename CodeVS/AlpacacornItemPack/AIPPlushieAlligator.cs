...
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    public partial class PlushieAlligatorRecipe : RecipeFamily
    {
        public PlushieAlligatorRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(TailoringSkill), start: 2.0f, skillType: typeof(TailoringSkill), typeof(TailoringFocusedSpeedTalent), typeof(TailoringParallelSpeedTalent));
