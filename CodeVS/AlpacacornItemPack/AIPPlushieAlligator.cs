...
public partial class AIPPlushieAlligatorObject : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPlushieAlligatorItem);
public override LocString DisplayName => Localizer.DoStr("Plushie Alligator");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPlushieAlligatorItem.homeValue;
this.ModsPostInitialize();
}
static AIPPlushieAlligatorObject()
{
...
WorldObject.AddOccupancy<AIPPlushieAlligatorObject>(occupancies);
}
...
public partial class AIPPlushieAlligatorItem : WorldObjectItem<AIPPlushieAlligatorObject>
{
...
{
ObjectName = typeof(AIPPlushieAlligatorObject).UILink(),
...
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Alligator Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushieAlligatorRecipe : RecipeFamily
{
public AIPPlushieAlligatorRecipe()
{
var recipe = new Recipe();
recipe.Init(
name: "AIPPlushieAlligator", //noloc
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushieAlligatorItem>(),});
...
this.ModsPreInitialize();
this.Initialize(displayText: Localizer.DoStr("Plushie Alligator"), recipeType: typeof(AIPPlushieAlligatorRecipe));
this.ModsPostInitialize();
