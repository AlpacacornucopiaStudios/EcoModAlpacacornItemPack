...
public partial class AIPPlushieSquidObject : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPlushieSquidItem);
public override LocString DisplayName => Localizer.DoStr("Plushie Squid");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPlushieSquidItem.homeValue;
this.ModsPostInitialize();
}
static AIPPlushieSquidObject()
{
...
WorldObject.AddOccupancy<AIPPlushieSquidObject>(occupancies);
}
...
public partial class AIPPlushieSquidItem : WorldObjectItem<AIPPlushieSquidObject>
{
...
{
ObjectName = typeof(AIPPlushieSquidObject).UILink(),
...
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Squid Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushieSquidRecipe : RecipeFamily
{
public AIPPlushieSquidRecipe()
{
var recipe = new Recipe();
recipe.Init(
name: "AIPPlushieSquid", //noloc
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushieSquidItem>(),});
...
this.ModsPreInitialize();
this.Initialize(displayText: Localizer.DoStr("Plushie Squid"), recipeType: typeof(AIPPlushieSquidRecipe));
this.ModsPostInitialize();
