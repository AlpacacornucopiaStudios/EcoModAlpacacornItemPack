...
public partial class AIPPlushieElephantPinkObject : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPlushieElephantPinkItem);
public override LocString DisplayName => Localizer.DoStr("Plushie Pink Elephant");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPlushieElephantPinkItem.homeValue;
this.ModsPostInitialize();
}
static AIPPlushieElephantPinkObject()
{
...
WorldObject.AddOccupancy<AIPPlushieElephantPinkObject>(occupancies);
}
...
public partial class AIPPlushieElephantPinkItem : WorldObjectItem<AIPPlushieElephantPinkObject>
{
...
{
ObjectName = typeof(AIPPlushieElephantPinkObject).UILink(),
...
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Pink Elephant Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushieElephantPinkRecipe : RecipeFamily
{
public AIPPlushieElephantPinkRecipe()
{
var recipe = new Recipe();
recipe.Init(
name: "AIPPlushieElephantPink", //noloc
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushieElephantPinkItem>(),});
...
this.ModsPreInitialize();
this.Initialize(displayText: Localizer.DoStr("Plushie Pink Elephant"), recipeType: typeof(AIPPlushieElephantPinkRecipe));
this.ModsPostInitialize();
