namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieStrawberryObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieStrawberryItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Strawberry");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieStrawberryItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieStrawberryObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieStrawberryObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Strawberry")]
    [LocDescription("A huggable Plushie Strawberry stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieStrawberryItem : WorldObjectItem<AIPPlushieStrawberryObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieStrawberryObject).UILink(),
    ...
    {
        public AIPPlushieStrawberryRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieStrawberry", //noloc
            displayName: Localizer.DoStr("Plushie Strawberry"),
            ...
            new IngredientElement(typeof(IronOxideItem), 25, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
            new IngredientElement(typeof(BluePowderItem), 15, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)),
            new IngredientElement(typeof(AIPGlassEyeBeadItem), 2, true),
            },
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieStrawberryItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Strawberry"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Strawberry"), recipeType: typeof(AIPPlushieStrawberryRecipe));
            this.ModsPostInitialize();
