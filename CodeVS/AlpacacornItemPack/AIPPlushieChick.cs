namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Chick Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieChickObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieChickItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Chick");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieChickItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieChickObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieChickObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Chick")]
    [LocDescription("A huggable Plushie Chick stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieChickItem : WorldObjectItem<AIPPlushieChickObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieChickObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Chick Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieChickRecipe : RecipeFamily
    {
        public AIPPlushieChickRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieChick", //noloc
            displayName: Localizer.DoStr("Plushie Chick"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieChickItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Chick"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Chick"), recipeType: typeof(AIPPlushieChickRecipe));
            this.ModsPostInitialize();
