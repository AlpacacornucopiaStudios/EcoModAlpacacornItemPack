namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieElephantObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieElephantItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Elephant");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieElephantItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieElephantObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieElephantObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Elephant")]
    [LocDescription("A huggable Plushie Elephant stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieElephantItem : WorldObjectItem<AIPPlushieElephantObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieElephantObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Elephant Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieElephantRecipe : RecipeFamily
    {
        public AIPPlushieElephantRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieElephant", //noloc
            displayName: Localizer.DoStr("Plushie Elephant"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieElephantItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Elephant"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Elephant"), recipeType: typeof(AIPPlushieElephantRecipe));
            this.ModsPostInitialize();
