...
[Tag("Usable")]
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Platypus Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushiePlatypusObject : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPlushiePlatypusItem);
public override LocString DisplayName => Localizer.DoStr("Plushie Platypus");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPlushiePlatypusItem.homeValue;
this.ModsPostInitialize();
}
static AIPPlushiePlatypusObject()
{
...
WorldObject.AddOccupancy<AIPPlushiePlatypusObject>(occupancies);
}
...
[Serialized]
[SupportedOSPlatform("windows7.0")]
[LocDisplayName("Plushie Platypus")]
[LocDescription("A huggable Plushie Platypus stuffed with cotton.")]
[Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
[Tag("Housing")]
[Tag("Plushie")]
[Weight(100)]
[Tag(nameof(SurfaceTags.CanBeOnRug))]
public partial class AIPPlushiePlatypusItem : WorldObjectItem<AIPPlushiePlatypusObject>
{
...
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Platypus Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushiePlatypusRecipe : RecipeFamily
{
public AIPPlushiePlatypusRecipe()
{
var recipe = new Recipe();
recipe.Init(
name: "AIPPlushiePlatypus", //noloc
displayName: Localizer.DoStr("Plushie Platypus"),
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushiePlatypusItem>(),});
...
// Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Platypus"
this.ModsPreInitialize();
this.Initialize(displayText: Localizer.DoStr("Plushie Platypus"), recipeType: typeof(AIPPlushiePlatypusRecipe));
this.ModsPostInitialize();
