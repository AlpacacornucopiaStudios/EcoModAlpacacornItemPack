...
[Tag("Usable")]
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Precious Squid Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushieSquidPreciousObject : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPlushieSquidPreciousItem);
public override LocString DisplayName => Localizer.DoStr("Plushie Precious Squid");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPlushieSquidPreciousItem.homeValue;
this.ModsPostInitialize();
}
static AIPPlushieSquidPreciousObject()
{
...
WorldObject.AddOccupancy<AIPPlushieSquidPreciousObject>(occupancies);
}
...
[Serialized]
[SupportedOSPlatform("windows7.0")]
[LocDisplayName("Plushie Precious Squid")]
...
public partial class AIPPlushieSquidPreciousItem : WorldObjectItem<AIPPlushieSquidPreciousObject>
{
...
{
ObjectName = typeof(AIPPlushieSquidPreciousObject).UILink(),
...
[Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Precious Squid Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPlushieSquidPreciousRecipe : RecipeFamily
{
public AIPPlushieSquidPreciousRecipe()
{
var recipe = new Recipe();
recipe.Init(
name: "AIPPlushieSquidPrecious", //noloc
displayName: Localizer.DoStr("Plushie Precious Squid"),
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushieSquidPreciousItem>(),});
...
// Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Precious Squid"
this.ModsPreInitialize();
this.Initialize(displayText: Localizer.DoStr("Plushie Precious Squid"), recipeType: typeof(AIPPlushieSquidPreciousRecipe));
this.ModsPostInitialize();
