namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieBearBowtieBlueObject : WorldObject, IRepresentsItem
    {
        ...
        {
            WorldObject.AddOccupancy<AIPPlushieBearBowtieBlueObject>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    public partial class AIPPlushieBearBowtieBlueRecipe : Recipe
    {
        public AIPPlushieBearBowtieBlueRecipe()
        {
            ...
            {
                new CraftingElement<AIPPlushieBearBowtieBlueItem>(),
            });

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Bear with Blue Bowtie"
            this.ModsPostInitialize();
