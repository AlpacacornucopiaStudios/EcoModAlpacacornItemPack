...
public partial class AIPPlushieLandsharkObject : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPlushieLandsharkItem);
public override LocString DisplayName => Localizer.DoStr("Plushie Landshark");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPlushieLandsharkItem.homeValue;
this.ModsPostInitialize();
}
static AIPPlushieLandsharkObject()
{
...
WorldObject.AddOccupancy<AIPPlushieLandsharkObject>(occupancies);
}
...
[Serialized]
[SupportedOSPlatform("windows7.0")]
[LocDisplayName("Plushie Landshark")]
[LocDescription("Leslie the Landshark is ready to be your friend. She is legally distinct from all other landsharks.")]
[Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
[Tag("Housing")]
[Tag("Plushie")]
[Weight(100)]
[Tag(nameof(SurfaceTags.CanBeOnRug))]
public partial class AIPPlushieLandsharkItem : WorldObjectItem<AIPPlushieLandsharkObject>
{
...
{
public AIPPlushieLandsharkRecipe()
{
var recipe = new Recipe();
recipe.Init(
name: "AIPPlushieLandshark", //noloc
displayName: Localizer.DoStr("Plushie Landshark"),
...
items: new List<CraftingElement>{new CraftingElement<AIPPlushieLandsharkItem>(),});
...
// Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Landshark"
this.ModsPreInitialize();
