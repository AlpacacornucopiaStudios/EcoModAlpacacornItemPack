namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Avocado Half 1 Item")]
    [SupportedOSPlatform("windows7.0")]

    public partial class AIPPlushieAvocadoHalf1Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieAvocadoHalf1Item);
        public override LocString DisplayName => Localizer.DoStr("Plushie Avocado Half 1");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieAvocadoHalf1Item.homeValue;
            this.ModsPostInitialize();
        }

        static AIPPlushieAvocadoHalf1Object()
        {
            WorldObject.AddOccupancy<AIPPlushieAvocadoHalf1Object>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Avocado Half 1")]
    [LocDescription("A huggable plushie Avocado stuffed with cotton. It is looking for its friend Plushie Avocado Half 2.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieAvocadoHalf1Item : WorldObjectItem<AIPPlushieAvocadoHalf1Object>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieAvocadoHalf1Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Avocado Half 1 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieAvocadoHalf1Recipe : RecipeFamily
    {
        public AIPPlushieAvocadoHalf1Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AIPPlushieAvocadoHalf1", //noloc
                displayName: Localizer.DoStr("Plushie Avocado Half 1"),
            ...
            {
                new CraftingElement<AIPPlushieAvocadoHalf1Item>(),
            });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Avocado Half 1"), recipeType: typeof(AIPPlushieAvocadoHalf1Recipe));
            this.ModsPostInitialize();
