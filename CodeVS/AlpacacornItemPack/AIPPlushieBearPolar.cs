namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Polar Bear Item")]
    [SupportedOSPlatform("windows7.0")]

    public partial class AIPPlushieBearPolarObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieBearPolarItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Polar Bear");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieBearPolarItem.homeValue;
            this.ModsPostInitialize();
        }

        static AIPPlushieBearPolarObject()
        {
            WorldObject.AddOccupancy<AIPPlushieBearPolarObject>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Polar Bear")]
    [LocDescription("A huggable Plushie Polar Bear stuffed with cotton. It appears to be wiggling and wants to be held.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieBearPolarItem : WorldObjectItem<AIPPlushieBearPolarObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieBearPolarObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Polar Bear Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieBearPolarRecipe : RecipeFamily
    {
        public AIPPlushieBearPolarRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AIPPlushieBearPolar", //noloc
                displayName: Localizer.DoStr("Plushie Polar Bear"),
            ...
            {
                new CraftingElement<AIPPlushieBearPolarItem>(),
            });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Polar Bear"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Polar Bear"), recipeType: typeof(AIPPlushieBearPolarRecipe));
            this.ModsPostInitialize();
