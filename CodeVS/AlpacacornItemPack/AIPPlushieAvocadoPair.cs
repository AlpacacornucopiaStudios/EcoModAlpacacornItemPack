namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieAvocadoPairObject : WorldObject, IRepresentsItem
    {
        ...
        public override LocString DisplayName => Localizer.DoStr("Plushie Avocado Pair");
        ...
        {
            WorldObject.AddOccupancy<AIPPlushieAvocadoPairObject>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Avocado Pair")]
