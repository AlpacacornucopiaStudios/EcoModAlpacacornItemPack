namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 06 Item")]
    [SupportedOSPlatform("windows7.0")]

    public partial class PetRock06Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(PetRock06Item);
        public override LocString DisplayName => Localizer.DoStr("Pet Rock 06");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;

        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = PetRock06Item.homeValue;
            this.ModsPostInitialize();
        }

        static PetRock06Object()
        {
            WorldObject.AddOccupancy<PetRock06Object>(new List<BlockOccupancy>(){
//Vector3(x, y, z): x is left/right, y is up/down, z is forward/backward
    ...
    public partial class PetRock06Item : WorldObjectItem<PetRock06Object>
    {
        ...
        {
            ObjectName = typeof(PetRock06Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 06 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class PetRock06Recipe : RecipeFamily
    {
        public PetRock06Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PetRock06", //noloc
                displayName: Localizer.DoStr("Pet Rock 06"),
            ...
            {
                new CraftingElement<PetRock06Item>(),
            });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Pet Rock 06"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Pet Rock 06"), recipeType: typeof(PetRock06Recipe));
            this.ModsPostInitialize();
