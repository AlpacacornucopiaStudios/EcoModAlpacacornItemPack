namespace Eco.Mods.TechTree
{
    ...
    public partial class PlushieMushroom1Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(PlushieMushroom1Item);
        ...
        protected override void Initialize()
        {
            ...
            this.GetComponent<HousingComponent>().HomeValue = PlushieMushroom1Item.homeValue;
            this.ModsPostInitialize();
        }

        static PlushieMushroom1Object()
        {
            WorldObject.AddOccupancy<PlushieMushroom1Object>(new List<BlockOccupancy>(){
    ...
    public partial class PlushieMushroom1Item : WorldObjectItem<PlushieMushroom1Object>
    {
        ...
        {
            ObjectName = typeof(PlushieMushroom1Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Mushroom 1 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class PlushieMushroom1Recipe : RecipeFamily
    {
        public PlushieMushroom1Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PlushieMushroom1", //noloc
            ...
            {
                new CraftingElement<PlushieMushroom1Item>(),
            });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Mushroom 1"), recipeType: typeof(PlushieMushroom1Recipe));
            this.ModsPostInitialize();
