namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Giraffe Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieGiraffeObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieGiraffeItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Giraffe");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieGiraffeItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieGiraffeObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieGiraffeObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Giraffe")]
    [LocDescription("A huggable Plushie Giraffe stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieGiraffeItem : WorldObjectItem<AIPPlushieGiraffeObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieGiraffeObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Giraffe Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieGiraffeRecipe : RecipeFamily
    {
        public AIPPlushieGiraffeRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieGiraffe", //noloc
            displayName: Localizer.DoStr("Plushie Giraffe"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieGiraffeItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Giraffe"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Giraffe"), recipeType: typeof(AIPPlushieGiraffeRecipe));
            this.ModsPostInitialize();
