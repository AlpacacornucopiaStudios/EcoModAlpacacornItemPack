namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieMushroom2Object : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieMushroom2Item);
        public override LocString DisplayName => Localizer.DoStr("Plushie Mushroom 2");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieMushroom2Item.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieMushroom2Object()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieMushroom2Object>(occupancies);
        }
    ...
    public partial class AIPPlushieMushroom2Item : WorldObjectItem<AIPPlushieMushroom2Object>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieMushroom2Object).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Mushroom 2 Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieMushroom2Recipe : RecipeFamily
    {
        public AIPPlushieMushroom2Recipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieMushroom2", //noloc
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieMushroom2Item>(), });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Mushroom 2"), recipeType: typeof(AIPPlushieMushroom2Recipe));
            this.ModsPostInitialize();
