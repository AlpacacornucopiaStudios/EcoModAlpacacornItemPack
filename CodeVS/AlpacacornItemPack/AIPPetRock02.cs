...
public partial class AIPPetRock02Object : WorldObject, IRepresentsItem
{
public virtual Type RepresentedItemType => typeof(AIPPetRock02Item);
public override LocString DisplayName => Localizer.DoStr("Pet Rock 02");
public override TableTextureMode TableTexture => TableTextureMode.Stone;
protected override void Initialize()
{
this.ModsPreInitialize();
this.GetComponent<HousingComponent>().HomeValue = AIPPetRock02Item.homeValue;
this.ModsPostInitialize();
}
static AIPPetRock02Object()
{
...
WorldObject.AddOccupancy<AIPPetRock02Object>(occupancies);
}
...
public partial class AIPPetRock02Item : WorldObjectItem<AIPPetRock02Object>
{
...
{
ObjectName = typeof(AIPPetRock02Object).UILink(),
...
[Ecopedia("Housing Objects", "Decoration", subPageName: "Pet Rock 02 Item")]
[SupportedOSPlatform("windows7.0")]
public partial class AIPPetRock02Recipe : Recipe
{
public AIPPetRock02Recipe()
{
this.Init(
name: "AIPPetRock02", //noloc
displayName: Localizer.DoStr("Pet Rock 02"),
ingredients: new List<IngredientElement>
{
            new IngredientElement(typeof(OilItem), 5, true),
            new IngredientElement(typeof(OilPaintItem), 6, true),
            new IngredientElement("Rock",30, true),
},
items: new List<CraftingElement>{new CraftingElement<AIPPetRock02Item>(),});
this.ModsPreInitialize();
this.ModsPostInitialize();
