namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieHabaneroObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieHabaneroItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Habanero");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieHabaneroItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieHabaneroObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieHabaneroObject>(occupancies);
        }
    ...
    public partial class AIPPlushieHabaneroItem : WorldObjectItem<AIPPlushieHabaneroObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieHabaneroObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Habanero Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieHabaneroRecipe : RecipeFamily
    {
        public AIPPlushieHabaneroRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieHabanero", //noloc
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieHabaneroItem>(), });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Habanero"), recipeType: typeof(AIPPlushieHabaneroRecipe));
            this.ModsPostInitialize();
