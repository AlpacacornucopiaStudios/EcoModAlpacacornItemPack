namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Bee Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieBeeObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieBeeItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Bee");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieBeeItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieBeeObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieBeeObject>(occupancies);
        }
    ...
    [Serialized]
    [SupportedOSPlatform("windows7.0")]
    [LocDisplayName("Plushie Bee")]
    [LocDescription("A huggable Plushie Bee stuffed with cotton.")]
    [Ecopedia("Housing Objects", "Decoration", createAsSubPage: true)]
    [Tag("Housing")]
    [Tag("Plushie")]
    [Weight(100)]
    [Tag(nameof(SurfaceTags.CanBeOnRug))]
    public partial class AIPPlushieBeeItem : WorldObjectItem<AIPPlushieBeeObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieBeeObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Bee Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieBeeRecipe : RecipeFamily
    {
        public AIPPlushieBeeRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieBee", //noloc
            displayName: Localizer.DoStr("Plushie Bee"),
            ...
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieBeeItem>(), });
            ...
            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Plushie Bee"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Bee"), recipeType: typeof(AIPPlushieBeeRecipe));
            this.ModsPostInitialize();
