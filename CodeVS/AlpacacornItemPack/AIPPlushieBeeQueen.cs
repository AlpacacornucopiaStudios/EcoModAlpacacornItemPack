namespace Eco.Mods.TechTree
{
    ...
    public partial class AIPPlushieBeeQueenObject : WorldObject, IRepresentsItem
    {
        public virtual Type RepresentedItemType => typeof(AIPPlushieBeeQueenItem);
        public override LocString DisplayName => Localizer.DoStr("Plushie Bee Queen");
        public override TableTextureMode TableTexture => TableTextureMode.Stone;
        protected override void Initialize()
        {
            this.ModsPreInitialize();
            this.GetComponent<HousingComponent>().HomeValue = AIPPlushieBeeQueenItem.homeValue;
            this.ModsPostInitialize();
        }
        static AIPPlushieBeeQueenObject()
        {
            ...
            WorldObject.AddOccupancy<AIPPlushieBeeQueenObject>(occupancies);
        }
    ...
    public partial class AIPPlushieBeeQueenItem : WorldObjectItem<AIPPlushieBeeQueenObject>
    {
        ...
        {
            ObjectName = typeof(AIPPlushieBeeQueenObject).UILink(),
    ...
    [Ecopedia("Housing Objects", "Decoration", subPageName: "Plushie Bee Queen Item")]
    [SupportedOSPlatform("windows7.0")]
    public partial class AIPPlushieBeeQueenRecipe : RecipeFamily
    {
        public AIPPlushieBeeQueenRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
            name: "AIPPlushieBeeQueen", //noloc
            ...
            new IngredientElement(typeof(GoldBarItem), 5, true),
            },
            items: new List<CraftingElement> { new CraftingElement<AIPPlushieBeeQueenItem>(), });
            ...
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Plushie Bee Queen"), recipeType: typeof(AIPPlushieBeeQueenRecipe));
            this.ModsPostInitialize();
